...
const char *spcmd2[] = {TERMINAL,
                        ...
                        "spcalc",
                        "-o",
                        "initial_window_width=340",
                        "-o",
                        "initial_window_height=540",
                        "bc",
                        "-lq",
                        NULL};
const char *spcmd3[] = {TERMINAL,
                        "--name",
                        "spbitward",
                        "-o",
                        "initial_window_width=960",
                        ...
                        "bitwarden-desktop",
                        NULL};
const char *spcmd4[] = {TERMINAL,
                        "--name",
                        "sptelegram",
                        "-o",
                        "initial_window_width=960",
                        "-o",
                        "initial_window_height=740",
                        "telegram-desktop",
                        NULL};
const char *spcmd5[] = {TERMINAL,
                        "--name",
                        "spdiscord",
                        "-o",
...
static const Rule rules[] = {
    ...
    {TERMCLASS, "sptelegram", NULL, SPTAG(3), 1, 1, 0, -1},
    {TERMCLASS, "spdiscord", NULL, SPTAG(4), 1, 1, 0, -1},
};
...
static const char *termcmd[] = {
    TERMINAL, "-o", "allow_remote_control=yes", "-o", "enabled_layouts=tall",
    "-e", "nu",  NULL};
...
static const Key keys[] = {
    ...
    // { MODKEY|ShiftMask,		XK_BackSpace,	spawn,		{.v =
    ...
    //                 "2>/dev/null")},
    {MODKEY, XK_e, spawn,
     {.v = (const char *[]){TERMINAL, "-e", "vial", NULL}}},
    ...
    {MODKEY | ShiftMask, XK_b, spawn, {.v = (const char *[]){"blueman", NULL}}},
    {MODKEY,
     XK_n,
     spawn,
    ...
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 3%+; kill -44 "
           "$(pidof "
           "dwmblocks)")},
